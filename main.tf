# TODO: Sendgrid無料アカウントではサブユーザの検証を出来なかったのでどこかで確認したい。
# サブユーザ毎に管理しようと思ったらどんなディレクトリ構成がいいんだろう？
resource "sendgrid_teammate" "teammate1" {
  email    = "NOTE: ここにチームメイトのメールアドレスが入る。"
  is_admin = true
  scopes   = [
    "2fa_required",
